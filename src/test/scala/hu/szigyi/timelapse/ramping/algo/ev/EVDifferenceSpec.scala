...
class EVDifferenceSpec extends FunSpec with Matchers {
  ...
  private def xmpSS(ss: BigDecimal): XMPSettings = XMPSettings(100, ss, BigDecimal("1.0"), BigDecimal("0.0"), false, 3400)
  private def xmpA(a: BigDecimal): XMPSettings = XMPSettings(100, BigDecimal("0.25"), a, BigDecimal("0.0"), false, 3400)
  private def xmpI(i: Int): XMPSettings = XMPSettings(i, BigDecimal("0.25"), BigDecimal("1.0"), BigDecimal("0.0"), false, 3400)
